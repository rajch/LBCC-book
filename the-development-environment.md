...
1. Download and install Mono. On Linux, be sure to get `mono-all`, or ensure that you have the `mono`, `mono-devel`, `mono-utils` and `mono-vbnc` packages.
...
In 2016, we have the Visual Studio Express editions, and even the full-fledged Visual Studio Community Edition, which includes the modern .NET Platform SDK. Mono, meanwhile, has gained a very respectable Visual Basic compiler called 